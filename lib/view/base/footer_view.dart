...
class FooterView extends StatefulWidget {
  ...
  const FooterView(
      {required this.child, this.minHeight = 0.65, this.visibility = true});
...
class FooterButton extends StatelessWidget {
  ...
  final bool url;
  const FooterButton(
      {required this.title, required this.route, this.url = false});
