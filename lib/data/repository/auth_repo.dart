...
import 'package:cfit/data/modal/body/social_log_in_body.dart';
...
class AuthRepo {
  ...
  Future<Response> loginWithSocialMedia(String email) async {
    return await apiClient.postData(
        AppConstants.SOCIAL_LOGIN_URL, {"email": email}, '');
  }
  ...
  String getRefreshToken() {
    return sharedPreferences.getString(AppConstants.TOKEN_REFRESH) ?? "";
  }
